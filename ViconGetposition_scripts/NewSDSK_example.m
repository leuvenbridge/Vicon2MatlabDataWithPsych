...
%       end
  ...
  FrameCount = [FrameCount; Frame]; % This will create a column array and will append the new frame number to the bottom of the column for each new iteration of the while loop 
  
  plot(FrameCount) % plots the frame count
  hold on % keeps the previous cells on the graph
...
%   LabeledMark
  MarkerCount = MyClient.GetLabeledMarkerCount().MarkerCount;
